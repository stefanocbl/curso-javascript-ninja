(function(){
    ...
    */
    ...
    console.log( text.replace( /Manuel Marques de Sousa/, 'Beltrano dos Anzóis' ) );
    ...
    */
    ...
    //ou
    console.log( text.replace(/a/gi, 4) ); //i é o ignore case, ou seja pega tanto 'a' como 'A'.
    ...
    */
    ...
    function getMonthNumber( monthName ) {
        var months = {
            janeiro: '01',
            fevereiro: '02',
            'março': '03', // está entre '' por causa do ç
            abril: '04',
            maio: '05',
            junho: '06',
            julho: '07',
